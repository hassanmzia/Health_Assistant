    ...
    <div className="space-y-6">
      ...
      <div className="flex items-start justify-between">
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          <div className={clsx(
            'h-10 w-10 sm:h-16 sm:w-16 rounded-full flex items-center justify-center shrink-0',
          ...
          <div className="min-w-0">
            ...
            <p className="text-sm sm:text-base text-gray-600">MRN: {patient.identifier_mrn}</p>
      ...
      <div className="border-b border-gray-200">
        <nav className="-mb-px flex space-x-2 sm:space-x-4 overflow-x-auto scrollbar-hide pb-px">
          {tabs.map((tab) => {
            const Icon = tab.icon
            return (
              <button
                ...
                className={clsx(
                  'flex items-center gap-1 sm:gap-2 py-2 sm:py-3 px-1 border-b-2 font-medium text-xs sm:text-sm whitespace-nowrap',
                  activeTab === tab.id
